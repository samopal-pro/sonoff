...
* Установка уровня япкости по обоим каналам (теплый и холодгый свет) 0-100
* Сохранение настроек в EEPROM
* Управление по HTTP GET для интеграции с устроствами умного дома http://<адресс>/on?auth=<pass> и http://<адресс>/off?auth=<pass>
* Пароль для GET HTTP устанавливается в настройках. По умолчнию - "12345"
* Пароли сохраняются в EEPROM в зашиврованном виде SHA256
* 
* 
